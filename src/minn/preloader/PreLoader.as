...
//			this.addChild(waitTxt);
		...
		private function imgHandler(evt:Event):void{
			img.x=(this.stage.width  -img.width)/2+80;
			img.y=(this.stage.height-img.height)/2;
			progressText.x=(this.stage.width  -img.width)/2+90;
			progressText.y=(this.stage.height-progressText.height)/2+70;
		}
