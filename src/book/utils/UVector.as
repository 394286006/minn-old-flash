package book.utils
{
	...
	public class UVector
	{
		...
		public function UVector(p0:Point,p1:Point)
		{
			this.p0 = p0.clone();
			this.p1 = p1.clone();
		}
		...
		public function clone():UVector
		{
			return new UVector(p0,p1);
		}
		...
		public function add(v:UVector):void
		{
			p1.x += v.x;
			p1.y += v.y;		
		}
		public function dot(v:UVector):Number
		{
			return x * v.x + y * v.y;
		}
		...
		public function reflect(n:UVector):void
		{
			n = n.clone();
			n.mult(2 * dot(n));
			p1.x -= n.x;
